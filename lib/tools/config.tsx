...
export const allTools: Tool[] = [
  {
    ...
    title: "Web Check",
    description:
      "Analyze websites for security, performance, and technology stack",
  ...
  },
  {
    ...
    title: "Text Compare",
    description:
      "Compare two texts and highlight differences with multiple options",
  ...
  },
  {
    ...
    description:
      "Parse, inspect, and analyze browser cookies with detailed attributes",
  ...
  },
  {
    ...
    title: "JWT Viewer",
    description:
      "Decode and view JWT tokens with header, payload, and signature details",
